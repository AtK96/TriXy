...
public class MainActivity extends Activity implements ISpeechRecognitionServerEvents {
    ...
    public void onFinalResponseReceived(final RecognitionResult response) {
        ...
        if (!isFinalDicationMessage) {
            // this.WriteLine("********* Final Results *********");
            for (int i = 0; i < 1; i++) {
                this.WriteLine(" Text=\"" + response.Results[i].DisplayText + "\"");
                button.setVisibility(View.VISIBLE);
                if (response.Results[i].DisplayText.equals("Start coding.")) {
                    WriteLine("You are now coding");
                }


                if (response.Results[i].DisplayText.equals("Public class hello world braces public static void main brackets String args braces system.out.println hello world.")) {
                    WriteLine("public class HelloWorld {" +
                            "public static void main(String[] args) {" +
                            "System.out.println(\"Hello, World\");}\n");
                }

                if (response.Results[i].DisplayText.equals("Open up a for loop.")) {
                    WriteLine("for ( i=0; i<n; i++ );");
                }


                if (response.Results[i].DisplayText.equals("Write a hello world program.")) {
                    WriteLine("public class HelloWorld {\n" +
                            "\n" +
                            "    public static void main(String[] args) {\n" +
                ...
                if (response.Results[i].DisplayText.contains("Write a bubble sort program.")) {
